...
-- -----------------------------------------------------
-- Table `hcode_ecommerce_db`.`order_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hcode_ecommerce_db`.`order_status` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `hcode_ecommerce_db`.`order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hcode_ecommerce_db`.`order` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `id_cart` INT(11) NOT NULL,
  ...
  `date_register` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  INDEX `FK_orders_carts_idx` (`id_cart` ASC) VISIBLE,
  INDEX `FK_orders_users_idx` (`id_user` ASC) VISIBLE,
  INDEX `fk_orders_ordersstatus_idx` (`id_status` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_orders_ordersstatus`
    ...
    REFERENCES `hcode_ecommerce_db`.`order_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
